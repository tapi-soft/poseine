...
void EditDraw::update()
{
    ...
    if (prev2 != 0) { ScenarioDraw::draw(prev2, 500, 625, 0.1); }
    if (prev1 != 0) { ScenarioDraw::draw(prev1, 650, 625, 0.1); }
    ScenarioDraw::draw(num, 800, 625, 0.1);
    if (next1 != 0) { ScenarioDraw::draw(next1, 950, 625, 0.1); }
    if (next2 != 0) { ScenarioDraw::draw(next2, 1100, 625, 0.1); }
}